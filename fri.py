...
def prove_low_degree(values, root_of_unity, maxdeg_plus_1, modulus, exclude_multiples_of=0):
    ...
    print("# If the degree we are checking for is less than or equal to 32,\
    # use the polynomial directly as a proof: ", maxdeg_plus_1)
    if maxdeg_plus_1 <= 16:
    ...
    # Compute the indices 4 points in each row to interpolate and calc the 40 points
